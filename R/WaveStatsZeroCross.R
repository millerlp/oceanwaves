# Filename: waveHeightZeroCross.R
...
#%
#		% Without output argument, the wave parameter are display on the 
#		% screen and the histograms of wave height and wave period are
#		% plotted.
#		%
...
waveStatsZeroCross <- function(data, Fs, threshold = NULL, plot = FALSE){
	# Sanity checks
	if (!is.vector(data)){
...
} # end of waveHeightZeroCross function
